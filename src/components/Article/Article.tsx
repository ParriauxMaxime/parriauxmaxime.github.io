...
function Article({ children, id }: { children: JSX.Element; id?: string }) {
  return (
    <article className="relative">
      ...
      <div className="relative flex flex-wrap w-full md:items-center justify-around min-h-[100vh] md:min-h-[93vh] md:max-h-80vh m-auto md:max-w-screen py-12 md:py-20 px-4 md:px-8">
        <div className="flex flex-col w-full md:w-[80vw] lg:w-[60vw] 3xl:w-[50vw]">
          {children}
        </div>
      </div>
